...
ANSWER: User authentication / authorization
[x] What steps can you take in your web apps to keep your data secure?
ANSWER: Implement login authentication and private routes.
[x] Describe how web servers work.
ANSWER: Web servers handle requests from web browsers/clients and then 'serves' the browser a respone in the form of a web page/data.
